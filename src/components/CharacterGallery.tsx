    ...
    <section id="hood" className="relative mx-auto max-w-6xl overflow-hidden px-4 py-24 sm:py-32">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <motion.article
          ...
          style={{ transformPerspective: 1200 }}
          className="flex flex-col items-center justify-center gap-3 rounded-3xl border-2 border-dashed border-[color:var(--color-neon)]/40 bg-[color:var(--color-neon)]/5 p-8 text-center"
        >
